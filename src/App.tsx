    ...
    return (
        <div className="px-4 space-y-2 pt-2 animate-in fade-in duration-300">
            ...
            <div className="flex items-center gap-4 p-3 rounded-2xl hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer transition-all">
                ...
                <span className="text-sm font-semibold text-gray-700 dark:text-gray-200">Danh sách bạn bè</span>
            </div>
            ...
            <div className="flex items-center gap-4 p-3 rounded-2xl hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer transition-all">
                ...
                <span className="text-sm font-semibold text-gray-700 dark:text-gray-200">Nhóm & Cộng đồng</span>
            </div>
            ...
            <div className="flex items-center gap-4 p-3 rounded-2xl hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer transition-all">
                ...
                <div className="flex-1 flex justify-between">
                    <span className="text-sm font-semibold text-gray-700 dark:text-gray-200">Lời mời kết bạn</span>
                    <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-red-500 text-white">3</span>
                </div>
            </div>
...
//     const isContactActive = location.pathname === '/contacts';
//
//     const handleLogout = () => {
    ...
    return (
        <Router>
            <Routes>
                ...
                >
                    {/*<Route path="contacts" element={<ContactWindow />} />*/}
                </Route>
