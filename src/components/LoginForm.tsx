    ...
    <div className="w-1/2 h-screen flex items-center justify-center bg-gray-50 overflow-hidden">
      ...
      >
        ...
        <div className="text-right mt-2 mb-7">
          <a 
            href="#forgot" 
            className="text-[15px] text-primary no-underline cursor-pointer font-medium transition-opacity duration-200 hover:opacity-70 hover:underline"
          >
            Quên mật khẩu?
          </a>
        </div>
        ...
        <div className="text-center text-[15px] text-gray-600">
          Chưa có tài khoản? <a href="#signup" className="text-primary no-underline cursor-pointer font-semibold transition-opacity duration-200 hover:opacity-70 hover:underline">Đăng ký</a>
        </div>
      </form>
    </div>
  );
